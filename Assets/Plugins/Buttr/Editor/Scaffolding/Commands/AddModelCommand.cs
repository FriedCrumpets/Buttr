namespace Buttr.Editor.Scaffolding {
    internal readonly ref struct AddModelCommand {
        ...
        public AddModelCommand(string packageFolder, bool refreshAssetDatabase) {
        ...
        public void Execute() {
            ...
            folder.WriteFileIfNew($"{name}Model.cs", new ButtrModelTemplate(ns, name).Generate(), m_RefreshAssetDatabase);
        }
    }
}