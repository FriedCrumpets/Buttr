...
namespace Buttr.Core {
    internal static class ObjectFactory {
        internal static Func<object[], TConcrete> Create<TConcrete>(ConstructorInfo constructor, Type[] parameters) {
            ...
            for (var i = 0; i < parameters.Length; i++) {
                ...
                var convertExpr = Expression.Convert(arrayAccess, parameters[i]);
